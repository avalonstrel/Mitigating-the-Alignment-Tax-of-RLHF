...
class FinetunerArguments(TrainingArguments):
    ...
    approach: Optional[str] = field(
        default="default",
        metadata={"help": "The method to alleviate the forgetting."
                  }
    )
    alpha: Optional[float] = field(
        default=0,
        metadata={"help": "The parameter for the regularization methods."
                  }
    )
    kl_weight: Optional[float] = field(
        ...
        metadata={
            "help": (
                "KL regularized weight in rewards."
            ),
        },
    )
...
@dataclass
class MaskFinetunerArguments(TrainingArguments):
    """
    Adapt transformers.TrainingArguments
    """
    eval_dataset_path: Optional[str] = field(
    ...
    mask_level: Optional[str] = field(
        default="default",
        metadata={"help": "The method used for mask levels."
                  }
    )
    gpu_id: Optional[str] = field(
        default="0",
        metadata={"help": "(Not a good choice, to decide which device to use.)."
                  }
    )
    approach: Optional[str] = field(
        default="default",
        metadata={"help": "The method used to mask interpolation."
                  }
    )
    ...
    sum_reg_type: Optional[float] = field(
        default=0,
        metadata={"help": "The parameter for the regularization methods."
                  }
    )
    init_val: Optional[float] = field(
        default=0.2,
        metadata={"help": "The parameter for the regularization methods."
                  }
    )
...
class EvaluatorArguments:
    ...
    weight_ensamble_names_paths: List[str] = field(
        default=None,
        metadata={
            "help": (
                "The paths or names for the model your want to weight ensamble. Separated by space."
            )
        },
    )

    alphas_path: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                "The path to the combination alphas."
            )
        },
    )

    weight_ensamble_ratios: List[float] = field(
        default=None,
        metadata={
            "help": (
                "The ratios/weights for models to be ensambled. Separated by Space"
            )
        },
    )
    weight_ensamble_save_path: Optional[str] = field(
        default=None,
        metadata={
            "help": (
                "The path for saving the emsambed model."
            )
        },
    )
...
PIPELINE_ARGUMENT_MAPPING = {
    ...
    "continual_finetuner": FinetunerArguments,
    "mask_finetuner": MaskFinetunerArguments,
    "evaluator": EvaluatorArguments,
    "inferencer": InferencerArguments,
    "raft_aligner": RaftAlignerArguments,
    "raft_aligner_eval": RaftAlignerArguments,
}
