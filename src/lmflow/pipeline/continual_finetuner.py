...
from lmflow.pipeline.utils.continual_trainer import ContinualTrainer

logger = logging.getLogger(__name__)


class ContinualFinetuner(BaseTuner):
    """
    Aims to test and solve forgetting problems in LLMs.
    Initializes the `ContinualFinetuner` class with given arguments.
    ...
    def tune(self, model, dataset, transform_dataset_in_place=True):
        ...
        if model_args.use_lora:
            ...
            FinetuningTrainer = ContinualTrainer
            trainer_callbacks = []
